...
const testimonials: Testimonial[] = [
    {
        ...
        quote: "Working with Webmines was one of the best decisions for our business. They transformed our outdated website into a modern platform that loads fast, looks incredible, and converts visitors into customers.",
    ...
    },
    {
        ...
        quote: "The team delivered exactly what they promised. Their attention to detail, responsiveness, and technical expertise made the entire development process smooth from start to finish.",
        author: "Kevin Huang",
    ...
    },
    {
        ...
        quote: "Webmines didn't just build our website—they solved business problems with thoughtful design and scalable engineering. Their communication and execution exceeded expectations.",
    ...
    },
    {
        ...
        quote: "From UI/UX to performance optimization, every aspect of the project was handled professionally. We've seen a noticeable increase in engagement and lead generation after launch.",
        author: "Sarah Patel",
    ...
    },
    {
        ...
        quote: "Their developers understood our vision immediately and delivered a polished product ahead of schedule. The final result feels premium and performs flawlessly across devices.",
    ...
    },
    {
        ...
        quote: "The Webmines team combines creativity with technical excellence. They built a website that perfectly represents our brand while maintaining exceptional speed and usability.",
        author: "James Wilson",
...
export default function Testimonials() {
    ...
    const scroll = (direction: 'left' | 'right') => {
        if (carouselRef.current) {
            ...
            const gap = 24; // Approx gap size (gap-6 in tailwind is 24px)
    ...
    return (
        <section className="py-16 md:py-24 overflow-hidden bg-white font-sans">
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 md:mb-14">
                    <div className="text-center md:text-left flex-1 max-w-2xl">
                        <span className="inline-flex items-center gap-2 text-[10px] sm:text-xs font-bold tracking-[0.15em] uppercase text-gray-900/60 mb-4 md:mb-5">
                            <span className="w-1 h-1 bg-gray-900/60 rounded-full"></span>
                            Testimonials
                        </span>
                ...
                >
                    ...
                    {/* Decorative partial card on desktop (optional to match image exactly, but real data is better. We'll rely on the scroll position) */}
                    ...
                    {testimonials.map((testimonial) => (
                        ...
                        >
                            ...
                            <img
                                ...
                                alt={`${testimonial.author} from ${testimonial.companyName}`}
                                className="absolute inset-0 w-full h-full object-cover bg-gray-200"
                            />

                            {/* Dark Gradient Overlay */}
                            <div className="absolute inset-0 bg-gradient-to-t from-[#1a0f0a]/95 via-[#1a0f0a]/40 to-transparent"></div>
                            ...
                            <div className="absolute inset-0 p-6 md:p-8 flex flex-col justify-between z-10">
                                ...
                                <div className="flex flex-col gap-3 md:gap-4 mt-auto">
                                    {/* Quote Icon */}
                                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className="text-white opacity-90 mb-1" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M10 11L8 15H10V19H4V15L6 11H4V7H10V11ZM20 11L18 15H20V19H14V15L16 11H14V7H20V11Z" fill="currentColor" />
                                    </svg>

                                    <p className="text-white/95 text-[15px] md:text-[16px] leading-[1.6] font-light">
                                        "{testimonial.quote}"
                                    </p>

                                    <div className="text-right mt-1 md:mt-2">
                                        <span className="text-white/70 text-[13px] md:text-sm font-light">
