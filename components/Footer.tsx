// Footer is a pure Server Component — no hooks needed.
// The newsletter form uses a standard HTML form action (no JS needed for basic submit).
export default function Footer() {
  return (
    <section className="w-full max-w-[1400px] mx-auto p-4 sm:p-6 lg:p-8 font-sans bg-white below-fold">
      <footer className="bg-[#121212] text-white rounded-[2rem] p-8 md:p-14 lg:p-16 w-full flex flex-col">
        <div className="flex flex-col md:flex-row justify-between w-full">
          <div className="flex flex-col max-w-[380px]">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[22px] font-medium tracking-tight">Webmines</span>
            </div>
          ...
          <nav
            className="flex gap-20 lg:gap-32 mt-12 md:mt-2"
        ...
        <div className="mt-14 md:mt-24 w-full max-w-[400px]">
          <h2 className="text-[16px] text-[#E5E5E5] mb-5">Subscribe to our newsletter</h2>
          {/*
            Using a standard HTML form with method="post" avoids the need for
            'use client' just for onSubmit. Wire action to an API route or
            service endpoint when ready.
          */}
          <form
            className="flex items-center bg-[#242424] rounded-full p-[6px] border border-[#333333] focus-within:border-[#555555] transition-colors"
            action="#"
            method="post"
          >
            ...
            >
              ...
              <div
                className="bg-[#121212] rounded-full w-[26px] h-[26px] flex items-center justify-center transition-transform group-hover:scale-105"
                aria-hidden="true"
              >
                <svg
                  viewBox="0 0 24 24"
        ...
        <div className="mt-16 md:mt-20">
          <p className="text-[#666666] text-[13px]">
            &copy; 2025 Webmines. All rights reserved.
          </p>
        </div>
      </footer>
    </section>
