...
export default function AboutUs() {
    return (
        <section className="bg-white py-16 px-4 md:px-8 font-sans antialiased text-[#141210]">
            {/* Increased max-width to make it wider */}
            <div className="max-w-[1400px] mx-auto">
                ...
                {/* Grid Section - Reduced height from 480px to 340px to make it slim */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:h-[340px]">
                    ...
                    <div className="relative rounded-2xl overflow-hidden bg-gradient-to-b from-[#56A5E3] to-[#1C80CD] p-4 flex flex-col justify-between h-[340px] md:h-full group">
                        ...
                        <div
                            ...
                            style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?auto=format&fit=crop&q=80&w=600")' }}
                        ></div>
                        ...
                        <div className="relative z-10 flex justify-between items-start w-full">
                            ...
                            <button className="bg-white/90 backdrop-blur-sm w-9 h-9 rounded-xl flex items-center justify-center shadow-sm hover:scale-105 transition-transform">
                        ...
                        {/* Bottom White Overlay - Adjusted paddings and rounded corners */}
                    ...
                    {/* Card 2: Quote & Metrics - Adjusted paddings and rounded corners */}
                    <div className="bg-[#F7F8F7] rounded-2xl p-7 flex flex-col justify-between h-[340px] md:h-full">
                        ...
                        <div>
                            ...
                            <div className="flex -space-x-3 mb-4">
                                <img src="https://i.pravatar.cc/100?img=11" alt="Avatar 1" className="w-10 h-10 rounded-full border-[3px] border-[#F7F8F7] object-cover" />
                                <img src="https://i.pravatar.cc/100?img=47" alt="Avatar 2" className="w-10 h-10 rounded-full border-[3px] border-[#F7F8F7] object-cover" />
                                <img src="https://i.pravatar.cc/100?img=12" alt="Avatar 3" className="w-10 h-10 rounded-full border-[3px] border-[#F7F8F7] object-cover" />
                                <img src="https://i.pravatar.cc/100?img=32" alt="Avatar 4" className="w-10 h-10 rounded-full border-[3px] border-[#F7F8F7] object-cover" />
                            </div>

                            <p className="text-[14px] font-medium leading-relaxed text-[#141210]/90">
                                &ldquo;They didn&apos;t just build us a website; they engineered a complete conversion system. Our brand practically sells itself now.&rdquo;
                            </p>
                        </div>
                    </div>

                    {/* Column 3: Split Cards - Adjusted heights, gaps, and rounded corners */}
                    <div className="flex flex-col gap-4 h-[340px] md:h-full">
                        ...
                        {/* Bottom Black Card - Fixed slim height and rounded corners */}
